    ...
    <div class="profile-wrapper-area py-3">
      ...
      <div class="card user-info-card">
        <div class="card-body p-4 d-flex align-items-center">
          <div class="user-profile me-3"><img id="profile-pic" src="{{ auth()->user()->profile_picture ? asset('storage/' . auth()->user()->profile_picture) : asset('dist/img/human/subiakto-intro.jpg') }}" alt="" style="height: 75px;"></div>
          <div class="user-info">
