...
class BookSeeder extends Seeder
{
    ...
    public function run()
    {
        Book::create([
            ...
            'desc' => '<p>Bukan sekedar buku, ini adalah Kitab panduan BISA BIKIN BRAND karangan Subiakto Priosoedarsono atau yang akrab disapa Pak Bi, seorang Praktisi Branding dengan pengalaman 54 tahun di dunia branding.</p><br>
                    <p>Pak Bi berhasil membranding brand-brand besar nasional seperti KOPIKO dengan taglinenya Gantinya Ngopi, Indomie Seleraku, Extra Jos, Kartu AS Telkomsel, Paspor BCA serta berhasil membangun personal brand dan mengantar Pak SBY-JK terpilih menjadi Presiden dan Wakil Presiden Indonesia lewat Pemilihan umum lansung, dan ratusan brand-brand nasional lainnya buah karya Pak Bi.</p><br>
